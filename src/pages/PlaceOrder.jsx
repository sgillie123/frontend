    ...
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <button onClick={()=>navigate('/orders')} className="w-full bg-black text-white py-3 font-medium hover:bg-gray-500 transition">CHECKOUT</button>
          <button onClick={()=>navigate('/collection')} className="w-full  bg-black text-white py-3 font-medium hover:bg-gray-500 transition mt-3">CONTINUE SHOPPING</button>
